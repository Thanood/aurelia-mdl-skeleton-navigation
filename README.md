# aurelia-mdl-skeleton-navigation

## Material Design Lite
This is a fork of aurelia-skeleton-navigation, using Material Design Lite for layout. It serves as a playground to develop/test mdl custom elements.
